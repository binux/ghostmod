...
private:
	...
	// mod
	uint32_t m_ChannelUserCount;					// Users in the channel
    vector<string> m_InChannelBots;                 // Bots in the channel
...
public:
	...
	// mod
	uint32_t GetChannelUserCount( )		{ return m_ChannelUserCount; }
