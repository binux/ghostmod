...
#define CLIENT_VERSIONID_WAR3   0x00000018
#define CLIENT_GAMEVERSION_WAR3 0x011804f3
#define CLIENT_EXEINFO_WAR3     "war3.exe 02/26/10 20:41:08 471040"
#define CLIENT_CHECKSUM_WAR3    0xde4443c5
